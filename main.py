...
def main(args):
    ...
    # print(f'Leitura de MD bit 0 {MEB.md_read(md=5, bit=0, type=0)}')
    # print(f'Leitura de MD bit 1 {MEB.md_read(md=5, bit=1, type=0)}')
    # print(f'Leitura de MD bit 2 {MEB.md_read(md=5, bit=2, type=0)}')
    # print(f'Leitura de MD bit 3 {MEB.md_read(md=5, bit=3, type=0)}')
    # print(f'Leitura de MD bit 4 {MEB.md_read(md=5, bit=4, type=0)}')
    # print(f'Leitura de MD bit 5 {MEB.md_read(md=5, bit=5, type=0)}')
    # print(f'Leitura de MD bit 6 {MEB.md_read(md=5, bit=6, type=0)}')
    # print(f'Leitura de MD bit 7 {MEB.md_read(md=5, bit=7, type=0)}')
    # print(f'Leitura de MD bit 8 {MEB.md_read(md=5, bit=8, type=0)}')
    # print(f'Leitura de MD bit 9 {MEB.md_read(md=5, bit=9, type=0)}')
    # print(f'Leitura de MD bit 10 {MEB.md_read(md=5, bit=10, type=0)}')
    # print(f'Leitura de MD bit 11 {MEB.md_read(md=5, bit=11, type=0)}')
    # print(f'Leitura de MD bit 12 {MEB.md_read(md=5, bit=12, type=0)}')
    # print(f'Leitura de MD bit 13 {MEB.md_read(md=5, bit=13, type=0)}')
    # print(f'Leitura de MD bit 14 {MEB.md_read(md=5, bit=14, type=0)}')
    # print(f'Leitura de MD bit 15 {MEB.md_read(md=5, bit=15, type=0)}')
    # print(f'Leitura de MD bit 16 {MEB.md_read(md=5, bit=16, type=0)}')
    # print(f'Leitura de MD bit 17 {MEB.md_read(md=5, bit=17, type=0)}')
    # print(f'Leitura de MD bit 18 {MEB.md_read(md=5, bit=18, type=0)}')
    # print(f'Leitura de MD bit 19 {MEB.md_read(md=5, bit=19, type=0)}')
    # print(f'Leitura de MD bit 20 {MEB.md_read(md=5, bit=20, type=0)}')
    # print(f'Leitura de MD bit 21 {MEB.md_read(md=5, bit=21, type=0)}')
    # print(f'Leitura de MD bit 22 {MEB.md_read(md=5, bit=22, type=0)}')
    # print(f'Leitura de MD bit 23 {MEB.md_read(md=5, bit=23, type=0)}')
    # print(f'Leitura de MD bit 24 {MEB.md_read(md=5, bit=24, type=0)}')
    # print(f'Leitura de MD bit 25 {MEB.md_read(md=5, bit=25, type=0)}')
    # print(f'Leitura de MD bit 26 {MEB.md_read(md=5, bit=26, type=0)}')
    # print(f'Leitura de MD bit 27 {MEB.md_read(md=5, bit=27, type=0)}')
    # print(f'Leitura de MD bit 28 {MEB.md_read(md=5, bit=28, type=0)}')
    # print(f'Leitura de MD bit 29 {MEB.md_read(md=5, bit=29, type=0)}')
    # print(f'Leitura de MD bit 30 {MEB.md_read(md=5, bit=30, type=0)}')
    # print(f'Leitura de MD bit 31 {MEB.md_read(md=5, bit=31, type=0)}')
